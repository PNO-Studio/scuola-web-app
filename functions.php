...
function is_school_email(string $email): bool {
    ...
    // cognome.nome@stu.lasboccioni.it oppure cognome.nome@lasboccioni.it
...
if (!is_school_email($email)) {
    throw new RuntimeException("Email non valida. Usa 'cognome.nome@stu.lasboccioni.it' oppure 'cognome.nome@lasboccioni.it'.");
}
